...
const char*         lightTopic   = "iot-2/evt/light/fmt/json";
...
void loop() {
    ...
    if (!mqClient.connected()) {
        ...
        delay(10);
        Joo_iot_publish(lightTopic, String(bright), "bright");
        delay(10);
...
void buttonClicked() {
    delay(50);
    Joo_iot_publish(switchTopic, "pushed", "sw1");
    delay(30);
}
